...
__command__ = 'archivestream version'
...
from archivestream.config import DATA_DIR, VERSION
...
def main(args: Optional[List[str]]=None, stdin: Optional[IO]=None, pwd: Optional[str]=None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog=__command__,
        description="Print the ArchiveStream version and dependency information",   # version.__doc__,
        add_help=True,
    ...
    parser.add_argument(
        '--quiet', '-q',
        action='store_true',
        help='Only print ArchiveStream version number and nothing else.',
    )
    parser.add_argument(
        '--binproviders', '-p',
        type=str,
