...
from archivestream.config.common import ARCHIVING_CONFIG, STORAGE_CONFIG
...
class WgetConfig(BaseConfigSet):
    ...
    def validate(self):
        if self.USE_WGET and self.WGET_TIMEOUT < 10:
            ...
            STDERR.print('        https://github.com/ArchiveStream/ArchiveStream/wiki/Configuration#save_media')
            STDERR.print()
        return self
