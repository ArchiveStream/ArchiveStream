...
class PuppeteerBinProvider(BinProvider):
    ...
    euid: Optional[int] = ARCHIVESTREAM_USER
    ...
    def setup(self) -> None:
        # update paths from config, don't do this lazily because we dont want to import archivestream.config.common at import-time
        # we want to avoid depending on archivestream from abx code if at all possible
