...
__homepage__ = 'https://github.com/ArchiveStream'
__order__ = 0
...
def get_plugin(plugin: PluginId | ModuleType | Type) -> PluginInfo:
    ...
    plugin_module_attrs = {
        ...
        'author': getattr(module, '__author__', 'ArchiveStream'),
        'homepage': getattr(module, '__homepage__', 'https://github.com/ArchiveStream'),
...
# Load all plugins from pip packages, archivestream built-ins, and user plugins
