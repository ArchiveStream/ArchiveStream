...
from archivestream.config.common import ARCHIVING_CONFIG, SHELL_CONFIG
from archivestream.misc.logging import STDERR
from archivestream.misc.util import dedupe
...
class ChromeConfig(BaseConfigSet):
    ...
    def validate(self):
        from archivestream.config.paths import create_and_chown_dir
        ...
        if self.USE_CHROME and self.CHROME_TIMEOUT < 15:
            ...
            STDERR.print()
            STDERR.print('    If you want to make ArchiveStream run faster, disable specific archive methods instead:')
            STDERR.print('        https://github.com/ArchiveStream/ArchiveStream/wiki/Configuration#archive-method-toggles')
            STDERR.print()
        ...
        if self.USE_CHROME and self.CHROME_USER_DATA_DIR:
            ...
            if not os.path.isdir(self.CHROME_USER_DATA_DIR / self.CHROME_PROFILE_NAME):
                ...
                STDERR.print('        https://github.com/ArchiveStream/ArchiveStream/wiki/Configuration#CHROME_USER_DATA_DIR')
