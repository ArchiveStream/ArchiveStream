...
from archivestream.misc.util import enforce_types, is_static_file

from archivestream.plugins_extractor.htmltotext.config import HTMLTOTEXT_CONFIG
...
def save_htmltotext(link: Link, out_dir: Optional[Path]=None, timeout: int=ARCHIVING_CONFIG.TIMEOUT) -> ArchiveResult:
    ...
    cmd = ['(internal) archivestream.extractors.htmltotext', './{singlefile,dom}.html']
