...
def get_vm_info():
    ...
    if platform.system().lower() == 'darwin':
        ...
        try:
            ...
            # SMBIOS 2.8 present.
            # argo-1        | 2024-10-01T10:40:51Z ERR  error="Incoming request ended abruptly: context canceled" connIndex=2 event=1 ingressRule=0 originService=http://archivestream:8000                                                                               │
...
def get_host_guid() -> str:
    return machineid.hashed_id('archivestream')
