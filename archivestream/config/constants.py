...
archivestream from inside a different DATA_DIR on the same machine.

This is loaded very early in the archivestream startup flow, so nothing in this file 
or imported from this file should import anything from archivestream.config.common, 
...
class ConstantsDict(Mapping):
    ...
    ARCHIVESTREAM_USER: int                = ARCHIVESTREAM_USER
    ARCHIVESTREAM_GROUP: int               = ARCHIVESTREAM_GROUP
    ...
    # Data dir files
    CONFIG_FILENAME: str                = 'ArchiveStream.conf'
    ...
    # When initializing archivestream in a new directory, we check to make sure the dir is
    ...
    # as they could be from a previous archivestream version, system artifacts, dependencies, etc.
...
# from archivestream.config.constants import IS_ROOT, PERSONAS_DIR, ...
