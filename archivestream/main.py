...
from archivestream.misc.checks import check_data_folder
from archivestream.misc.util import enforce_types                         # type: ignore
from archivestream.misc.system import get_dir_size, dedupe_cron_jobs, CRON_COMMENT
from archivestream.misc.system import run as run_shell
from archivestream.misc.logging import stderr, hint
from archivestream.config import CONSTANTS, VERSION, DATA_DIR, ARCHIVE_DIR
from archivestream.config.common import SHELL_CONFIG, SEARCH_BACKEND_CONFIG, STORAGE_CONFIG, SERVER_CONFIG, ARCHIVING_CONFIG
from archivestream.config.permissions import SudoPermission, IN_DOCKER
from archivestream.config.collection import (
    write_config_file,
    load_all_config,
    get_real_name,
)
...
def help(out_dir: Path=DATA_DIR) -> None:
    """Print the ArchiveStream help message and usage"""
...
[dodger_blue3]Docker Usage:[/dodger_blue3]
    ...
    [blue]docker compose run[/blue] [dark_green]archivestream[/dark_green] [green]\\[command][/green] [green3][...args][/green3] [violet][--help][/violet] [grey53][--version][/grey53]

    [grey53]# using Docker:[/grey53]
    [blue]docker run[/blue] -v [light_slate_blue]$PWD:/data[/light_slate_blue] [grey53]-p 8000:8000[/grey53] -it [dark_green]archivestream/archivestream[/dark_green] [green]\\[command][/green] [green3][...args][/green3] [violet][--help][/violet] [grey53][--version][/grey53]
''' if IN_DOCKER else ''
    DOCKER_DOCS = '\n    [link=https://github.com/ArchiveStream/ArchiveStream/wiki/Docker#usage]https://github.com/ArchiveStream/ArchiveStream/wiki/Docker[/link]' if IN_DOCKER else ''
...
[deep_sky_blue4]Usage:[/deep_sky_blue4]{DOCKER_OUTSIDE_HINT}
    [dark_green]archivestream[/dark_green] [green]\\[command][/green] [green3][...args][/green3] [violet][--help][/violet] [grey53][--version][/grey53]

[deep_sky_blue4]Commands:[/deep_sky_blue4]
    {COMMANDS_HELP_TEXT}

[deep_sky_blue4]Documentation:[/deep_sky_blue4]
    [link=https://github.com/ArchiveStream/ArchiveStream/wiki]https://github.com/ArchiveStream/ArchiveStream/wiki[/link]{DOCKER_DOCS}
    [link=https://github.com/ArchiveStream/ArchiveStream/wiki/Usage#cli-usage]https://github.com/ArchiveStream/ArchiveStream/wiki/Usage[/link]
    [link=https://github.com/ArchiveStream/ArchiveStream/wiki/Configuration]https://github.com/ArchiveStream/ArchiveStream/wiki/Configuration[/link]
''')
...
[violet]Hint:[/violet] [i]Common maintenance tasks:[/i]
    [dark_green]archivestream[/dark_green] [green]init[/green]      [grey53]# make sure database is up-to-date (safe to run multiple times)[/grey53]
    [dark_green]archivestream[/dark_green] [green]install[/green]   [grey53]# make sure plugins are up-to-date (wget, chrome, singlefile, etc.)[/grey53]
    [dark_green]archivestream[/dark_green] [green]status[/green]    [grey53]# get a health checkup report on your collection[/grey53]
    [dark_green]archivestream[/dark_green] [green]update[/green]    [grey53]# retry any previously failed or interrupted archiving tasks[/grey53]

[violet]Hint:[/violet] [i]More example usage:[/i]
    [dark_green]archivestream[/dark_green] [green]add[/green] --depth=1 "https://example.com/some/page"
    [dark_green]archivestream[/dark_green] [green]list[/green] --sort=timestamp --csv=timestamp,downloaded_at,url,title
    [dark_green]archivestream[/dark_green] [green]schedule[/green] --every=day --depth=1 "https://example.com/some/feed.rss"
    [dark_green]archivestream[/dark_green] [green]server[/green] [blue]0.0.0.0:8000[/blue]                [grey53]# Start the Web UI / API server[/grey53]
'''
        ...
        if IN_DOCKER:
            ...
            DATA_SETUP_HELP += '    docker run [violet]-v /some/path/data:/data[/violet] archivestream/archivestream ...\n\n'
        DATA_SETUP_HELP += 'To load an [dark_blue]existing[/dark_blue] collection:\n'
        DATA_SETUP_HELP += '    1. [green]cd[/green] ~/archivestream/data     [grey53]# go into existing [light_slate_blue]DATA DIR[/light_slate_blue] (can be anywhere)[/grey53]\n'
        DATA_SETUP_HELP += f'    2. {DOCKER_CMD_PREFIX}[dark_green]archivestream[/dark_green] [green]init[/green]          [grey53]# migrate to latest version (safe to run multiple times)[/grey53]\n'
        DATA_SETUP_HELP += f'    3. {DOCKER_CMD_PREFIX}[dark_green]archivestream[/dark_green] [green]install[/green]       [grey53]# auto-update all plugins (wget, chrome, singlefile, etc.)[/grey53]\n'
        DATA_SETUP_HELP += f'    4. {DOCKER_CMD_PREFIX}[dark_green]archivestream[/dark_green] [green]help[/green]          [grey53]# ...get help with next steps... [/grey53]\n\n'
        DATA_SETUP_HELP += 'To start a [sea_green1]new[/sea_green1] collection:\n'
        DATA_SETUP_HELP += '    1. [green]mkdir[/green] ~/archivestream/data  [grey53]# create a new, empty [light_slate_blue]DATA DIR[/light_slate_blue] (can be anywhere)[/grey53]\n'
        DATA_SETUP_HELP += '    2. [green]cd[/green] ~/archivestream/data     [grey53]# cd into the new directory[/grey53]\n'
        DATA_SETUP_HELP += f'    3. {DOCKER_CMD_PREFIX}[dark_green]archivestream[/dark_green] [green]init[/green]          [grey53]# initialize ArchiveStream in the new data dir[/grey53]\n'
        DATA_SETUP_HELP += f'    4. {DOCKER_CMD_PREFIX}[dark_green]archivestream[/dark_green] [green]install[/green]       [grey53]# auto-install all plugins (wget, chrome, singlefile, etc.)[/grey53]\n'
        DATA_SETUP_HELP += f'    5. {DOCKER_CMD_PREFIX}[dark_green]archivestream[/dark_green] [green]help[/green]          [grey53]# ... get help with next steps... [/grey53]\n'
        print(Panel(DATA_SETUP_HELP, expand=False, border_style='grey53', title='[red]:cross_mark: No collection is currently active[/red]', subtitle='All archivestream [green]commands[/green] should be run from inside a collection [light_slate_blue]DATA DIR[/light_slate_blue]'))
...
def version(quiet: bool=False,
    ...
    """Print the ArchiveStream version and dependency information"""
    ...
    from archivestream.config.version import get_COMMIT_HASH, get_BUILD_TIME
    from archivestream.config.permissions import ARCHIVESTREAM_USER, ARCHIVESTREAM_GROUP, RUNNING_AS_UID, RUNNING_AS_GID
    from archivestream.config.paths import get_data_locations, get_code_locations
    
    LDAP_ENABLED = archivestream.pm.hook.get_SCOPE_CONFIG().LDAP_ENABLED


    # 0.7.1
    # ArchiveStream v0.7.1+editable COMMIT_HASH=951bba5 BUILD_TIME=2023-12-17 16:46:05 1702860365
    ...
    prnt(
        '[dark_green]ArchiveStream[/dark_green] [dark_goldenrod]v{}[/dark_goldenrod]'.format(CONSTANTS.VERSION),
    ...
    prnt(
        f'EUID={os.geteuid()}:{os.getegid()} UID={RUNNING_AS_UID}:{RUNNING_AS_GID} PUID={ARCHIVESTREAM_USER}:{ARCHIVESTREAM_GROUP}',
    ...
    if not (os.access(CONSTANTS.ARCHIVE_DIR, os.R_OK) and os.access(CONSTANTS.CONFIG_FILE, os.R_OK)):
        PANEL_TEXT = '\n'.join((
            ...
            '',
            '[violet]Hint:[/violet] [green]cd[/green] into a collection [blue]DATA_DIR[/blue] and run [green]archivestream version[/green] again...',
            '      [grey53]OR[/grey53] run [green]archivestream init[/green] to create a new collection in the current dir.',
            '',
    ...
    failures = []
    BINARIES = abx.as_dict(archivestream.pm.hook.get_BINARIES())
    for name, binary in list(BINARIES.items()):
        if binary.name == 'archivestream':
            continue
    ...
    BINPROVIDERS = abx.as_dict(archivestream.pm.hook.get_BINPROVIDERS())
    ...
    if not (binaries or binproviders):
        ...
        if os.access(CONSTANTS.ARCHIVE_DIR, os.R_OK) or os.access(CONSTANTS.CONFIG_FILE, os.R_OK):
            ...
            from archivestream.misc.checks import check_data_dir_permissions
...
def run(subcommand: str,
    ...
    """Run a given ArchiveStream subcommand with the given list of args"""
    run_subcommand(
...
def init(force: bool=False, quick: bool=False, install: bool=False, out_dir: Path=DATA_DIR) -> None:
    """Initialize a new ArchiveStream collection in the current directory"""
    ...
    #     print("[red]    You can run `archivestream list --json --with-headers > static_index.json` to manually generate it.[/red]", file=sys.stderr)
    ...
    if is_empty and not existing_index:
        print(f'[turquoise4][+] Initializing a new ArchiveStream v{VERSION} collection...[/turquoise4]')
        print('[green]----------------------------------------------------------------------[/green]')
    elif existing_index:
        # TODO: properly detect and print the existing version in current index as well
        print(f'[green][*] Verifying and updating existing ArchiveStream collection to v{VERSION}...[/green]')
        print('[green]----------------------------------------------------------------------[/green]')
    else:
        if force:
            print('[red][!] This folder appears to already have files in it, but no index.sqlite3 is present.[/red]')
            print('[red]    Because --force was passed, ArchiveStream will initialize anyway (which may overwrite existing files).[/red]')
        else:
            print(
                ...
                "    then run and run 'archivestream init' to pick up where you left off.\n\n"
                "    (Always make sure your data folder is backed up first before updating ArchiveStream)"
                )
            )
            raise SystemExit(2)
    ...
    # create the .archivestream_id file with a unique ID for this collection
    from archivestream.config.paths import _get_collection_id
    _get_collection_id(CONSTANTS.DATA_DIR, force_create=True)
    
    # create the ArchiveStream.conf file
    ...
    if quick:
        ...
        try:
            ...
            if invalid_folders:
                ...
                print('        archivestream status')
                print('        archivestream list --status=invalid')

        except (KeyboardInterrupt, SystemExit):
            print(file=sys.stderr)
            print('[yellow]:stop_sign: Stopped checking archive directories due to Ctrl-C/SIGTERM[/yellow]', file=sys.stderr)
            print('    Your archive data is safe, but you should re-run `archivestream init` to finish the process later.', file=sys.stderr)
            print(file=sys.stderr)
            print('    [violet]Hint:[/violet] In the future you can run a quick init without checking dirs like so:', file=sys.stderr)
            print('        archivestream init --quick', file=sys.stderr)
            raise SystemExit(1)
    ...
    if existing_index:
        print('[green][√] Done. Verified and updated the existing ArchiveStream collection.[/green]')
    else:
        print(f'[green][√] Done. A new ArchiveStream collection was initialized ({len(all_links) + len(pending_links)} links).[/green]')
    ...
    from archivestream.config.common import STORAGE_CONFIG
    ...
    if Snapshot.objects.count() < 25:     # hide the hints for experienced users
        ...
        print('        archivestream server  # then visit [deep_sky_blue4][link=http://127.0.0.1:8000]http://127.0.0.1:8000[/link][/deep_sky_blue4]')
        print()
        print('    To add new links, you can run:')
        print("        archivestream add < ~/some/path/to/list_of_links.txt")
        print()
        print('    For more usage and examples, run:')
        print('        archivestream help')
...
def status(out_dir: Path=DATA_DIR) -> None:
    ...
    if num_indexed:
        ...
        print('        archivestream list --status=<status>  (e.g. indexed, corrupted, archived, etc.)')
    ...
    if not users:
        ...
        print('        archivestream manage createsuperuser')
...
def oneshot(url: str, extractors: str="", out_dir: Path=DATA_DIR, created_by_id: int | None=None) -> List[Link]:
    ...
    You can run this to archive single pages without needing to create a whole collection with archivestream init.
    """
...
def add(urls: Union[str, List[str]],
    ...
    # if CAN_UPGRADE:
    #     hint(f"There's a new version of ArchiveStream available! Your current version is {VERSION}. You can upgrade to {VERSIONS_AVAILABLE['recommended_version']['tag_name']} ({VERSIONS_AVAILABLE['recommended_version']['html_url']}). For more on how to upgrade: https://github.com/ArchiveStream/ArchiveStream/wiki/Upgrading-or-Merging-Archives\n")
    ...
    if snapshots is None:
        if filter_str and filter_patterns:
            ...
            hint(('To remove all urls you can run:',
                'archivestream remove --filter-type=regex ".*"'))
            stderr()
            raise SystemExit(2)
        elif filter_str:
...
def install(out_dir: Path=DATA_DIR, binproviders: Optional[List[str]]=None, binaries: Optional[List[str]]=None, dry_run: bool=False) -> None:
    """Automatically install all ArchiveStream dependencies and extras"""
    ...
    from archivestream.config.permissions import IS_ROOT, ARCHIVESTREAM_USER, ARCHIVESTREAM_GROUP
    from archivestream.config.paths import get_or_create_working_lib_dir
    ...
    print('\n[green][+] Installing ArchiveStream dependencies automatically...[/green]')
    ...
    if IS_ROOT:
        ...
        print(f'    DATA_DIR, LIB_DIR, and TMP_DIR will be owned by [blue]{ARCHIVESTREAM_USER}:{ARCHIVESTREAM_GROUP}[/blue].')
        print()
    ...
    for binary in reversed(list(abx.as_dict(abx.pm.hook.get_BINARIES()).values())):
        if binary.name in ('archivestream', 'django', 'sqlite', 'python'):
                    ...
                    for binprovider_name in binproviders:
                        ...
                        try:
                            if dry_run:
                                ...
                                loaded_binary = archivestream.pm.hook.binary_load_or_install(binary=binary, binproviders=[binprovider_name], fresh=True, dry_run=dry_run, quiet=False)
                                result = loaded_binary.model_dump(exclude={'overrides', 'bin_dir', 'hook_type'})
                            if result and result['loaded_version']:
                                break
                        except Exception as e:
                            print(f'[red]:cross_mark: Failed to install {binary.name} as using {binprovider_name} as user {ARCHIVESTREAM_USER}: {e}[/red]')
                else:
                    if dry_run:
                        sys.stderr.write("\033[2;49;90m")  # grey53
                        ...
                        loaded_binary = archivestream.pm.hook.binary_load_or_install(binary=binary, fresh=True, dry_run=dry_run)
                        result = loaded_binary.model_dump(exclude={'overrides', 'bin_dir', 'hook_type'})
            if IS_ROOT and LIB_DIR:
                with SudoPermission(uid=0):
                    if ARCHIVESTREAM_USER == 0:
                        os.system(f'chmod -R 777 "{LIB_DIR.resolve()}"')
                    else:    
                        os.system(f'chown -R {ARCHIVESTREAM_USER} "{LIB_DIR.resolve()}"')
        except Exception as e:
            print(f'[red]:cross_mark: Failed to install {binary.name} as user {ARCHIVESTREAM_USER}: {e}[/red]')
    ...
    if not User.objects.filter(is_superuser=True).exclude(username='system').exists():
        ...
        stderr('    archivestream manage createsuperuser')
        # run_subcommand('manage', subcommand_args=['createsuperuser'], pwd=out_dir)
    
    print('\n[green][√] Set up ArchiveStream and its dependencies successfully.[/green]\n', file=sys.stderr)
    
    from abx_plugin_pip.binaries import ARCHIVESTREAM_BINARY
    ...
    proc = run_shell([ARCHIVESTREAM_BINARY.load().abspath, 'version', *extra_args], capture_output=False, cwd=out_dir)
...
def config(config_options_str: Optional[str]=None,
           ...
           reset: bool=False,
           out_dir: Path=DATA_DIR) -> None:
    """Get and set your ArchiveStream project configuration values"""
    ...
    FLAT_CONFIG = archivestream.pm.hook.get_FLAT_CONFIG()
    CONFIGS = archivestream.pm.hook.get_CONFIGS()
    ...
    if search:
        ...
        if new_config:
            ...
            after = {**load_all_config(), **archivestream.pm.hook.get_FLAT_CONFIG()}
            print(printable_config(matching_config))
        ...
        stderr('    archivestream config')
        stderr('    archivestream config --get SOME_KEY')
        stderr('    archivestream config --set SOME_KEY=SOME_VALUE')
        raise SystemExit(2)
...
def schedule(add: bool=False,
             ...
             out_dir: Path=DATA_DIR):
    """Set ArchiveStream to regularly import URLs at specific times using cron"""
    
    check_data_folder()
    from abx_plugin_pip.binaries import ARCHIVESTREAM_BINARY
    from archivestream.config.permissions import USER
    ...
    if every or add:
        ...
        cmd = [
            ...
            quoted(out_dir),
            '&&',
            quoted(ARCHIVESTREAM_BINARY.load().abspath),
            *([
                'add',
        ...
        if every in ('minute', 'hour', 'day', 'month', 'year'):
            ...
            stderr('        archivestream init --every=day --depth=1 https://example.com/some/rss/feed.xml')
            stderr('        archivestream init --every="0/5 * * * *" --depth=1 https://example.com/some/rss/feed.xml')
            raise SystemExit(1)
        ...
        print()
        print('{green}[√] Scheduled new ArchiveStream cron job for user: {} ({} jobs are active).{reset}'.format(USER, len(existing_jobs), **SHELL_CONFIG.ANSI))
        print('\n'.join(f'  > {cmd}' if str(cmd) == str(new_job) else f'    {cmd}' for cmd in existing_jobs))
        if total_runs > 60 and not quiet:
            stderr()
            stderr('{lightyellow}[!] With the current cron config, ArchiveStream is estimated to run >{} times per year.{reset}'.format(total_runs, **SHELL_CONFIG.ANSI))
        ...
        if existing_jobs:
            ...
            stderr('{red}[X] There are no ArchiveStream cron jobs scheduled for your user ({}).{reset}'.format(USER, **SHELL_CONFIG.ANSI))
            stderr('    To schedule a new job, run:')
            stderr('        archivestream schedule --every=[timeperiod] --depth=1 https://example.com/some/rss/feed.xml')
        raise SystemExit(0)
    ...
    if foreground or run_all:
        if not existing_jobs:
            ...
            stderr('    archivestream schedule --every=hour --depth=1 https://example.com/some/rss/feed.xml')
            raise SystemExit(1)

        print('{green}[*] Running {} ArchiveStream jobs in foreground task scheduler...{reset}'.format(len(existing_jobs), **SHELL_CONFIG.ANSI))
        if run_all:
            try:
                for job in existing_jobs:
                    sys.stdout.write(f'  > {job.command.split("/archivestream ")[0].split(" && ")[0]}\n')
                    sys.stdout.write(f'    > {job.command.split("/archivestream ")[-1].split(" >> ")[0]}')
                    sys.stdout.flush()
                    job.run()
                    sys.stdout.write(f'\r    √ {job.command.split("/archivestream ")[-1]}\n')
        ...
        if foreground:
            try:
                for job in existing_jobs:
                    print(f'  > {job.command.split("/archivestream ")[-1].split(" >> ")[0]}')
...
def server(runserver_args: Optional[List[str]]=None,
           ...
           out_dir: Path=DATA_DIR) -> None:
    """Run the ArchiveStream HTTP server"""
    ...
    if not User.objects.filter(is_superuser=True).exclude(username='system').exists():
        ...
        print('      [green]archivestream manage createsuperuser[/green]')
        print()
    ...
    print('[green][+] Starting ArchiveStream webserver...[/green]')
    print(f'    [blink][green]>[/green][/blink] Starting ArchiveStream webserver on [deep_sky_blue4][link=http://{host}:{port}]http://{host}:{port}[/link][/deep_sky_blue4]')
    print(f'    [green]>[/green] Log in to ArchiveStream Admin UI on [deep_sky_blue3][link=http://{host}:{port}/admin]http://{host}:{port}/admin[/link][/deep_sky_blue3]')
    print('    > Writing ArchiveStream error log to ./logs/errors.log')
    ...
    if SHELL_CONFIG.DEBUG:
        ...
        print("\n[i][green][🟩] ArchiveStream server shut down gracefully.[/green][/i]")


@enforce_types
def manage(args: Optional[List[str]]=None, out_dir: Path=DATA_DIR) -> None:
    """Run an ArchiveStream Django management command"""
    ...
    if (args and "createsuperuser" in args) and (IN_DOCKER and not SHELL_CONFIG.IS_TTY):
        ...
        stderr('    docker run -it archivestream manage {}'.format(' '.join(args or ['...'])), color='lightyellow')
        stderr('')
...
def shell(out_dir: Path=DATA_DIR) -> None:
    """Enter an interactive ArchiveStream Django shell"""
