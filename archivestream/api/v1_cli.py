...
from archivestream.misc.util import ansi_to_html
from archivestream.config.common import ARCHIVING_CONFIG


from .auth import API_AUTH_METHODS

# router for API that exposes archivestream cli subcommands as REST endpoints
router = Router(tags=['ArchiveStream CLI Sub-Commands'], auth=API_AUTH_METHODS)
...
@router.post("/add", response=CLICommandResponseSchema, summary='archivestream add [args] [urls]')
...
@router.post("/update", response=CLICommandResponseSchema, summary='archivestream update [args] [filter_patterns]')
...
@router.post("/schedule", response=CLICommandResponseSchema, summary='archivestream schedule [args] [import_path]')
...
@router.post("/list", response=CLICommandResponseSchema, summary='archivestream list [args] [filter_patterns]')
...
@router.post("/remove", response=CLICommandResponseSchema, summary='archivestream remove [args] [filter_patterns]')
