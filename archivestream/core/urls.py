...
from archivestream.misc.serve_static import serve_static

from core.admin_site import archivestream_admin
from core.views import HomepageView, SnapshotView, PublicIndexView, AddView, HealthCheckView

# GLOBAL_CONTEXT doesn't work as-is, disabled for now: https://github.com/ArchiveStream/ArchiveStream/discussions/1306
# from archivestream.config import VERSION, VERSIONS_AVAILABLE, CAN_UPGRADE
...
urlpatterns = [
    ...
    path('docs/', RedirectView.as_view(url='https://github.com/ArchiveStream/ArchiveStream/wiki'), name='Docs'),
    ...
    path('admin/', archivestream_admin.urls),
