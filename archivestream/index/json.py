...
from archivestream.config import VERSION, DATA_DIR, CONSTANTS
from archivestream.config.common import SERVER_CONFIG, SHELL_CONFIG
...
def generate_json_index_from_links(links: List[Link], with_headers: bool):
    MAIN_INDEX_HEADER = {
        'info': 'This is an index of site data archived by ArchiveStream: The self-hosted web archive.',
        'schema': 'archivestream.index.json',
