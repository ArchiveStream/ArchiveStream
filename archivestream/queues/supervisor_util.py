__package__ = 'archivestream.queues'
...
from archivestream.config.paths import get_or_create_working_tmp_dir
from archivestream.config.permissions import ARCHIVESTREAM_USER
...
SCHEDULER_WORKER = {
    ...
    "command": "archivestream manage djangohuey --queue system_tasks -w 4 -k thread --disable-health-check --flush-locks",
    "autostart": "true",
    "autorestart": "true",
...
COMMAND_WORKER = {
    ...
    "command": "archivestream manage djangohuey --queue commands -w 4 -k thread --no-periodic --disable-health-check",
    "autostart": "true",
    "autorestart": "true",
...
def start_server_workers(host='0.0.0.0', port='8000', daemonize=False):
    ...
    fg_worker = {
        "name": "worker_daphne",
        "command": f"daphne --bind={host} --port={port} --application-close-timeout=600 archivestream.core.asgi:application",
        "autostart": "false",
        "autorestart": "true",
...
def start_cli_workers(watch=False):
    ...
    fg_worker = {
        ...
        "command": "archivestream manage djangohuey --queue system_tasks",
        "autostart": "true",
        "autorestart": "true",
