...
1. Confirm your desired features fit into our bigger project goals [Roadmap](https://github.com/pirate/ArchiveStream/wiki/Roadmap).
...
- https://github.com/ArchiveStream/ArchiveStream/issues
- https://github.com/ArchiveStream/ArchiveStream/pulls
- https://github.com/ArchiveStream/ArchiveStream/wiki/Roadmap
- https://github.com/ArchiveStream/ArchiveStream/wiki/Install#manual-setup

### Development Setup

```bash
git clone https://github.com/ArchiveStream/ArchiveStream
cd ArchiveStream
