...
echo "[🔒] Locking all ArchiveStream dependencies (pip, npm)"
echo
echo "pyproject.toml:              archivestream $py_version"
# echo "package.json:                archivestream $js_version"
echo
echo
...
# rm -f archivestream/package.json
# rm -f archivestream/package-lock.json
# rm -Rf ./.venv
# rm -Rf ./node_modules
# rm -Rf ./archivestream/node_modules
...
echo
echo "pyproject.toml:    archivestream $(grep 'version = ' pyproject.toml | awk '{print $3}' | jq -r)"
...
# cd etc
# echo
# echo "etc/package.json:  archivestream $(jq -r '.version' etc/package.json)"
# echo
...
# ls "archivestream/package.json" | cat
# ls "archivestream/package-lock.json" | cat
