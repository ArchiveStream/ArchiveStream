#!/usr/bin/env bash
# Helper script to export browser history and bookmarks to a format ArchiveStream can ingest.
# Usage:
#    curl -O 'https://raw.githubusercontent.com/ArchiveStream/ArchiveStream/dev/bin/export_browser_history.sh'
